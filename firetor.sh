...
sudo iptables -t nat -D PREROUTING -i $NAME -p udp --dport 53 -j REDIRECT --to-ports 5353
sudo iptables -t nat -D PREROUTING -i $NAME -p tcp --syn  -j REDIRECT --to-ports 9040
